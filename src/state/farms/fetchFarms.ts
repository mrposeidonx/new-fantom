...
const fetchFarms = async () => {
  const data = await Promise.all(
    farmsConfig.map(async (farmConfig) => {
      ...
      const [info, totalAllocPoint, fSapphirePerBlock] = await multicall(masterchefABI, [
        {
      ...
      return {
        ...
        fSapphirePerBlock: new BigNumber(fSapphirePerBlock).toNumber(),
